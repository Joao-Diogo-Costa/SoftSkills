            ...
            <div className="row p-0 justify-content-center align-items-center text-center" style={{ marginTop: "5%" }}>
                {cursos.slice(0, 1).map((curso) => (
                    <div className="col-12" key={curso.id}>
                        ...
                        <Link className="row mt-5 mb-5 d-flex align-items-center justify-content-center text-decoration-none" to={`/curso/${curso.id}`}>
                            <div className="col-md-3 col-8 text-center">
                                <img src={curso.imagem || "/img/MariaDB.png"} alt="MariaDB" className="img-fluid" />
                            </div>
                            <div className="col-md-4 col-10 text-center text-md-start">
                                <h3 className="fw-bold" style={{ color: "#39639D" }}>{curso.nome}</h3>
                                <p style={{ color: "#39639D" }}>{curso.descricaoCurso}</p>
                                <button className="btn btn-primary mb-3" type="button">Ver Curso</button>
                            </div>
                        </Link>
                    </div>
                ))}
