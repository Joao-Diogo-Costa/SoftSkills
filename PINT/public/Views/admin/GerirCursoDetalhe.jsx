...
import cursoBanner from "../../assets/admin/img/curso_banner.png";
...
function GerirCursoDetalhe() {
    ...
    useEffect(() => {
        ...
        axios.get("http://localhost:3000/inscricao/list")
            .then(res => {
                // Filtra inscrições deste curso e extrai utilizadores
                const inscritos = (res.data.data || [])
                    .filter(insc => insc.cursoId === Number(id))
                    .map(insc => insc.Utilizador)
                    .filter(Boolean); // Garante que só utilizadores válidos entram
    ...
    return (
        <>
            ...
            <div className="content flex-grow-1 p-4 ">
                ...
                <div
                    className="container d-flex justify-content-center align-items-center mt-5 mx.auto"
                    style={{
                        width: "100%",
                        backgroundColor: "#F5F9FF",
                ...
                >
                    <img src={curso.imagemBanner || cursoBanner} alt=""
                                    ...
                                    <div className="row mb-3">
                                        <div className="col-md-3">
                                            ...
                                            <Select
                                                ...
                                                value={categorias.find(cat => cat.id === categoriaSelecionada?.id) ? { value: categoriaSelecionada.id, label: categoriaSelecionada.nome } : null}
                                                onChange={() => { }}
                                        ...
                                        <div className="col-md-3">
                                            ...
                                            <Select
                                                ...
                                                value={areas.find(area => area.id === areaSelecionada?.id) ? { value: areaSelecionada.id, label: areaSelecionada.nome } : null}
                                                onChange={() => { }}
                                                menuPlacement="bottom"
                                                styles={selectEstilos}
                                        ...
                                        <div className="col-md-3">
                                            ...
                                            <Select
                                                id="topico"
                                                options={topicos.map(topico => ({ value: topico.id, label: topico.nomeTopico }))}
                                                value={topicos.find(topico => topico.id === curso.topicoId) ? { value: curso.topicoId, label: topicos.find(topico => topico.id === curso.topicoId).nomeTopico } : null}
                                                onChange={() => { }}
                                                menuPlacement="bottom"
                                                styles={selectEstilos}
                                        ...
                                        <div className="col-md-3">
                                            ...
                                            <Select
                                                ...
                                                value={formadores.find(formador => formador.id === curso.formadorId) ? { value: curso.formadorId, label: formadores.find(formador => formador.id === curso.formadorId).nomeUtilizador } : null}
                                                onChange={() => { }}
                                                menuPlacement="bottom"
                                                styles={selectEstilos}
