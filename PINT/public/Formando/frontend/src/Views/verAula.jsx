...
const VerAula = () => {
    return (
        <div className="container-fluid  m-0 p-0">
            ...
            <div className="row container2 d-flex justify-content-center mt-4 rounded-4 shadow-lg mb-5">
                ...
                <div className="col-12 col-lg-4 shadow-lg rounded-4 mt-5 mt-lg-0 ">
