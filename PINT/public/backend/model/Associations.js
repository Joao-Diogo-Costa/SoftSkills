...
const ProgressoAulaAssincrona = require("./ProgressoAulaAssincrona");
...
// ProgressoAulaAssincrona
ProgressoAulaAssincrona.belongsTo(Utilizador, { foreignKey: 'utilizadorId' });
ProgressoAulaAssincrona.belongsTo(AulaAssincrona, { foreignKey: 'aulaAssincronaId' });
ProgressoAulaAssincrona.belongsTo(Curso, { foreignKey: 'cursoId' });

Utilizador.hasMany(ProgressoAulaAssincrona, { foreignKey: 'utilizadorId' });
AulaAssincrona.hasMany(ProgressoAulaAssincrona, { foreignKey: 'aulaAssincronaId' });
Curso.hasMany(ProgressoAulaAssincrona, { foreignKey: 'cursoId' });
