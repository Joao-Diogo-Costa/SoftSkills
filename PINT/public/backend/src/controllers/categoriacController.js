...
controllers.categoria_list = async (req, res) => {
  try {
    ...
    res
      .status(500)
      .json({ success: false, message: "Erro ao listar categorias.", details: error.message });
  }
};
...
controllers.categoria_detail = async (req, res) => {
  try {
    ...
    res
      .status(500)
      .json({ success: false, message: "Erro ao buscar categoria.", details: error.message });
  }
};
...
controllers.categoria_update = async (req, res) => {
  try {
    ...
    res.status(500).json({ message: "Erro ao atualizar categoria.", details: error.message });
  }
};
...
controllers.categoria_delete = async (req, res) => {
  try {
    ...
    res.status(500).json({ message: "Erro ao apagar categoria.", details: error.message });
  }
};
