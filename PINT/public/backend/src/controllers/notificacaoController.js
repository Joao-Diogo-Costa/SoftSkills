...
controllers.notificacao_detail = async (req, res) => {
  try {
    ...
    res.status(500).json({ success: false, message: "Erro ao buscar notificação.", details: error.message });
  }
};
...
controllers.notificacao_update = async (req, res) => {
  try {
    ...
    res.status(500).json({ message: "Erro ao atualizar notificação.", details: error.message });
  }
};
...
controllers.notificacao_delete = async (req, res) => {
  try {
    ...
    res.status(500).json({ message: "Erro ao remover notificação.", details: error.message });
  }
};
