...
const documentoForumRoute = require("./routes/documentoForumRoute");
app.use("/documento-forum", documentoForumRoute);

const formadorRoute = require("./routes/formadorRoute");
app.use("/formador", formadorRoute);

const formandoRoute = require("./routes/formandoRoute");
app.use("/formando", formandoRoute);

const forumRoute = require("./routes/forumRoute");
app.use("/forum", forumRoute);

const gestorRoute = require("./routes/gestorRoute");
app.use("/gestor", gestorRoute);

const inscricaoRoute = require("./routes/inscricaoRoute");
app.use("/inscricao", inscricaoRoute);

const inscricaoCursoRoute = require("./routes/inscricaoCursoRoute");
app.use("/inscricao-curso", inscricaoCursoRoute);
...
// Sincroniza os modelos com o banco de dados sem usar force: true
sequelize.sync()
.then(() => {
