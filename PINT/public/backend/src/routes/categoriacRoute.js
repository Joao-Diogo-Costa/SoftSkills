...
router.post("/create", middleware.checkToken, categoriacController.categoria_create);

// PUT: Atualizar uma categoria existente
router.put("/update/:id", middleware.checkToken, categoriacController.categoria_update);

// DELETE: Apagar uma categoria
router.delete("/delete/:id", middleware.checkToken, categoriacController.categoria_delete);
