...
router.post("/create", middleware.checkToken, aulaSincronaController.aulaSincrona_create);

// PUT: Atualizar aula síncrona existente
router.put("/update/:id", middleware.checkToken, aulaSincronaController.aulaSincrona_update);

// DELETE: Apagar aula síncrona
router.delete("/delete/:id", middleware.checkToken, aulaSincronaController.aulaSincrona_delete);
