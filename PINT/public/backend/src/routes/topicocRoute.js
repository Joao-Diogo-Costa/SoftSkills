...
router.post("/create", middleware.checkToken, topicocController.topicoc_create);

// PUT: Atualizar um tópico existente
router.put("/update/:id", middleware.checkToken, topicocController.topicoc_update);

// DELETE: Remover tópico
router.delete("/delete/:id", middleware.checkToken, topicocController.topicoc_delete);
