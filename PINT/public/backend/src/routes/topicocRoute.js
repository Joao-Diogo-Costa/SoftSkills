...
router.post("/create", topicocController.topicoc_create);

// PUT: Atualizar um tópico existente
router.put("/update/:id", topicocController.topicoc_update);

// DELETE: Remover tópico
router.delete("/delete/:id", topicocController.topicoc_delete);
