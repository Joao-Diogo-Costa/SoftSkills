...
router.post("/:tarefaId/ficheiro", middleware.checkToken, upload.array("ficheiros"), tarefaFicheiroController.uploadTarefaFicheiro);

// Eliminar ficheiro de enunciado da tarefa
router.delete("/ficheiro/:fileId", middleware.checkToken, tarefaFicheiroController.deleteTarefaFicheiro );
