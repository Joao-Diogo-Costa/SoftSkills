...
controllers.forum_list = async (req, res) => {
  try {
    ...
    res.status(500).json({ success: false, message: "Erro ao listar fóruns.", error });
  }
};
...
controllers.forum_detail = async (req, res) => {
  try {
    ...
    res.status(500).json({ success: false, message: "Erro ao buscar fórum.", error });
  }
};
...
controllers.forum_create = async (req, res) => {
  try {
    ...
    res.status(500).json({ success: false, message: "Erro ao criar fórum.", error });
  }
};
...
o
    ...
    res.status(500).json({ error: "Erro ao atualizar fórum.", details: error.message });
  }
};
...
controllers.forum_delete = async (req, res) => {
  try {
    ...
    res.status(500).json({ error: "Erro ao apagar fórum.", details: error.message });
  }
};
