...
//Formando
import FormadorRoute from './Views/formador/FormadorRoute';
...
import PerfilUtilizador from './Views/admin/PerfilUtilizador';
    ...
    return (
      <>
        <Routes>
          ...
          <Route path="/forum/:id" element={<NavbarLayout><Forum /></NavbarLayout>} />
          ...
          {/* {Formador} */}
          <Route path="/curso-formador" element={<FormadorRoute><NavbarLayout><CursoFormador /></NavbarLayout></FormadorRoute>} />
          <Route path="/curso-formador/gerir/:id" element={<FormadorRoute><NavbarLayout><GerirConteudoCurso /></NavbarLayout></FormadorRoute>} />
          <Route path="/curso-formador/gerir/:id/gerir-submissao/:tarefaId" element={<FormadorRoute><NavbarLayout><GerirSubmissaoTarefa /></NavbarLayout></FormadorRoute>} />
          <Route path="/curso-formador/gerir-assincrono/:id" element={<FormadorRoute><NavbarLayout><GerirCursoAssincrono /></NavbarLayout></FormadorRoute>} />
          ...
          <Route path="/admin/perfil-utilizador/:id" element={<AdminRoute><PerfilUtilizador /></AdminRoute>} />
