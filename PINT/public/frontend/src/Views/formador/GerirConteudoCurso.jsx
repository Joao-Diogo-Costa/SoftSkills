        ...
        try {
            ...
            await axios.post(
                "http://localhost:3000/aviso/create",
                {
                    ...
                    cursoId: id,
                    utilizadorId: user?.id,
                    dataPublicacao: novoAviso.dataPublicacao || new Date(),
                },
                { headers: authHeader() }
            );

            // Atualizar lista de avisos
            axios.get(`http://localhost:3000/curso/${id}/aviso`, { headers: authHeader() })
                .then(res => setAvisos(res.data.data || []));
                                                ...
                                                <div className="modal-body mt-5" style={{ color: "#294873" }}>
                                                    ...
                                                    <div className="mb-3 ms-4 text-start">
                                                        ...
                                                        <input
                                                            type="datetime-local"
                                                            className="form-control text-muted"
                                                            value={novoAviso.dataPublicacao}
                                                            onChange={e => setNovoAviso({ ...novoAviso, dataPublicacao: e.target.value })}
                                                        />
                                                    </div>
                                                    <div className="modal-footer d-flex justify-content-center">
                                                        <button
                                ...
                                <div className="bg-white rounded p-3 shadow-sm mb-2">
                                    {avisos.length === 0 ? (
                                        ...
                                        avisos.map(aviso => (
                                            ...
                                            >
                                                <div>
                                                    <div className="fw-semibold" style={{ color: "#39639D", fontSize: 18 }}>
                                                        {aviso.titulo}
                                                    </div>
                                                    <div className="text-muted small mb-2" style={{ fontSize: 15 }}>
                                                        {aviso.descricao}
                                                    </div>
