...
function CursoCard({ id, imagem, nome, formador, dataRegisto, dataTermino, nota }) {
    return (
            <div className="row mt-4 p-0 ms-1 ms-md-2 align-items-center hover-shadow" style={{ cursor: "pointer" }}>
